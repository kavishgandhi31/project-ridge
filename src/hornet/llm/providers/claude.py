...
API key comes from Settings (HORNET_ANTHROPIC_API_KEY env var),
...
from hornet.llm.config import ClaudeConfig
...
class ClaudeProvider:
    ...
    async def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            raise ProviderError(
                self.provider_id,
                f"Authentication failed -- check HORNET_ANTHROPIC_API_KEY: {e}",
            ) from e
