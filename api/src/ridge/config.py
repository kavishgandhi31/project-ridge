...
class Settings(BaseSettings):
    ...
    Values are read from environment variables with the ``RIDGE_``
    ...
    # ---- Database ----
    db_url: str = Field(
        default="postgresql+psycopg://ridge:ridge@localhost:5432/ridge",
    ...
    # ---- Source credentials ----
    # Read from RIDGE_FRED_API_KEY. Wrapped in SecretStr so accidental
