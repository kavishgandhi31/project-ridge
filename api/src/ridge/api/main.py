...
also exposed for uvicorn's import-string loader::
    ...
    uv run uvicorn ridge.api.main:app --reload --port 8000
"""
...
from ridge.api.routes.alerts import router as alerts_router
from ridge.api.routes.ask import router as ask_router
from ridge.api.routes.countries import router as countries_router
from ridge.api.routes.narratives import router as narratives_router
from ridge.api.routes.observations import router as observations_router
from ridge.api.routes.pipeline import router as pipeline_router
from ridge.api.routes.quality import router as quality_router
from ridge.api.routes.scores import router as scores_router
