...
from hornet.domain.llm import GroundedContext
...
from hornet.llm.templates.interactive_query import InteractiveQueryTemplate
...
def _get_llm_router() -> LLMRouter:
    ...
    if settings.anthropic_api_key:
        ...
        logger.warning(
            ...
            msg="HORNET_ANTHROPIC_API_KEY not set -- /ask endpoint will fail",
        )
